...
cl_int clGetPlatformIDs(cl_uint num_entries, cl_platform_id *platforms, cl_uint *num_platforms) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetPlatformIDs;
...
cl_int clGetPlatformInfo(cl_platform_id platform,
  ...
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetPlatformInfo;
  MNN_CHECK_NOTNULL(func);
...
cl_int clGetDeviceIDs(cl_platform_id platform,
                      ...
                      cl_uint *num_devices) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetDeviceIDs;
  MNN_CHECK_NOTNULL(func);
...
cl_int clGetDeviceInfo(cl_device_id device,
                       ...
                       void *param_value,
                       size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetDeviceInfo;
  MNN_CHECK_NOTNULL(func);
  return func(device, param_name, param_value_size, param_value, param_value_size_ret);
}

cl_int clRetainDevice(cl_device_id device) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clRetainDevice;
  MNN_CHECK_NOTNULL(func);
  return func(device);
}

cl_int clReleaseDevice(cl_device_id device) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clReleaseDevice;
  MNN_CHECK_NOTNULL(func);
  return func(device);
}
...
cl_context clCreateContext(const cl_context_properties *properties,
                           ...
                           void *user_data,
                           cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateContext;
  MNN_CHECK_NOTNULL(func);
...
cl_context clCreateContextFromType(const cl_context_properties *properties,
                                   ...
                                   void *user_data,
                                   cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateContextFromType;
  MNN_CHECK_NOTNULL(func);
  return func(properties, device_type, pfn_notify, user_data, errcode_ret);
}

cl_int clRetainContext(cl_context context) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clRetainContext;
  MNN_CHECK_NOTNULL(func);
  return func(context);
}

cl_int clReleaseContext(cl_context context) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clReleaseContext;
  MNN_CHECK_NOTNULL(func);
  return func(context);
}
...
cl_int clGetContextInfo(cl_context context,
                        ...
                        void *param_value,
                        size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetContextInfo;
  MNN_CHECK_NOTNULL(func);
...
cl_program clCreateProgramWithSource(cl_context context,
                                     ...
                                     cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateProgramWithSource;
  MNN_CHECK_NOTNULL(func);
...
cl_int clGetProgramInfo(cl_program program,
                        ...
                        void *param_value,
                        size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetProgramInfo;
  MNN_CHECK_NOTNULL(func);
...
cl_int clGetProgramBuildInfo(cl_program program,
                             ...
                             void *param_value,
                             size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetProgramBuildInfo;
  MNN_CHECK_NOTNULL(func);
  return func(program, device, param_name, param_value_size, param_value, param_value_size_ret);
}

cl_int clRetainProgram(cl_program program) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clRetainProgram;
  MNN_CHECK_NOTNULL(func);
  return func(program);
}

cl_int clReleaseProgram(cl_program program) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clReleaseProgram;
  MNN_CHECK_NOTNULL(func);
  return func(program);
}
...
cl_int clBuildProgram(cl_program program,
                      ...
                      void *user_data) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clBuildProgram;
  MNN_CHECK_NOTNULL(func);
  return func(program, num_devices, device_list, options, pfn_notify, user_data);
}

cl_kernel clCreateKernel(cl_program program, const char *kernelName, cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateKernel;
  MNN_CHECK_NOTNULL(func);
  return func(program, kernelName, errcode_ret);
}

cl_int clRetainKernel(cl_kernel kernel) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clRetainKernel;
  MNN_CHECK_NOTNULL(func);
  return func(kernel);
}

cl_int clReleaseKernel(cl_kernel kernel) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clReleaseKernel;
  MNN_CHECK_NOTNULL(func);
  return func(kernel);
}

cl_int clSetKernelArg(cl_kernel kernel, cl_uint arg_index, size_t arg_size, const void *arg_value) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clSetKernelArg;
  MNN_CHECK_NOTNULL(func);
...
cl_mem clCreateBuffer(cl_context context,
                      ...
                      void *host_ptr,
                      cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateBuffer;
  MNN_CHECK_NOTNULL(func);
...
cl_mem clCreateImage(cl_context context, cl_mem_flags flags, const cl_image_format *image_format,
  ...
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateImage;
  MNN_CHECK_NOTNULL(func);
  return func(context, flags, image_format, image_desc, host_ptr, errcode_ret);
}

cl_int clRetainMemObject(cl_mem memobj) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clRetainMemObject;
  MNN_CHECK_NOTNULL(func);
  return func(memobj);
}

cl_int clReleaseMemObject(cl_mem memobj) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clReleaseMemObject;
  MNN_CHECK_NOTNULL(func);
  return func(memobj);
}
...
cl_int clGetImageInfo(cl_mem image,
                      ...
                      void *param_value,
                      size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetImageInfo;
  MNN_CHECK_NOTNULL(func);
  return func(image, param_name, param_value_size, param_value, param_value_size_ret);
}

cl_int clRetainCommandQueue(cl_command_queue command_queue) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clRetainCommandQueue;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue);
}

cl_int clReleaseCommandQueue(cl_command_queue command_queue) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clReleaseCommandQueue;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue);
}
...
cl_int clEnqueueReadBuffer(cl_command_queue command_queue,
                           ...
                           cl_event *event) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueReadBuffer;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue,
              buffer,
              blocking_read,
...
cl_int clEnqueueWriteBuffer(cl_command_queue command_queue,
                            ...
                            const cl_event *event_wait_list,
                            cl_event *event) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueWriteBuffer;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue,
              buffer,
              blocking_write,
...
cl_int clEnqueueReadImage(cl_command_queue command_queue,
  ...
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueReadImage;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue,
              cl_image,
              is_block,
...
cl_int clEnqueueWriteImage(cl_command_queue command_queue,
                           ...
                           const cl_event *event_wait_list,
                           cl_event *event) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueWriteImage;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue,
              cl_image,
              is_block,
...
void *clEnqueueMapBuffer(cl_command_queue command_queue,
                         ...
                         cl_event *event,
                         cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueMapBuffer;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue,
              buffer,
              blocking_map,
...
void *clEnqueueMapImage(cl_command_queue command_queue,
                        ...
                        cl_event *event,
                        cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueMapImage;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue,
              image,
              blocking_map,
...
cl_int clEnqueueUnmapMemObject(cl_command_queue command_queue,
                               ...
                               const cl_event *event_wait_list,
                               cl_event *event) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueUnmapMemObject;
  MNN_CHECK_NOTNULL(func);
...
cl_int clGetKernelWorkGroupInfo(cl_kernel kernel,
                                ...
                                void *param_value,
                                size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetKernelWorkGroupInfo;
  MNN_CHECK_NOTNULL(func);
...
cl_int clGetEventProfilingInfo(cl_event event,
                               ...
                               void *param_value,
                               size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetEventProfilingInfo;
  MNN_CHECK_NOTNULL(func);
...
cl_int clEnqueueNDRangeKernel(cl_command_queue command_queue, cl_kernel kernel, cl_uint work_dim,
  ...
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueNDRangeKernel;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue,
              kernel,
              work_dim,
...
cl_int clWaitForEvents(cl_uint num_events, const cl_event *event_list) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clWaitForEvents;
  MNN_CHECK_NOTNULL(func);
  return func(num_events, event_list);
}

cl_int clRetainEvent(cl_event event) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clRetainEvent;
  MNN_CHECK_NOTNULL(func);
  return func(event);
}

cl_int clReleaseEvent(cl_event event) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clReleaseEvent;
  MNN_CHECK_NOTNULL(func);
  return func(event);
}
...
cl_int clGetEventInfo(cl_event event,
                      ...
                      void *param_value,
                      size_t *param_value_size_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clGetEventInfo;
  MNN_CHECK_NOTNULL(func);
  return func(event, param_name, param_value_size, param_value, param_value_size_ret);
}

cl_int clFlush(cl_command_queue command_queue) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clFlush;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue);
}

cl_int clFinish(cl_command_queue command_queue) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clFinish;
  MNN_CHECK_NOTNULL(func);
  return func(command_queue);
}
...
cl_mem clCreateImage2D(cl_context context,
                       ...
                       void *host_ptr,
                       cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateImage2D;
  MNN_CHECK_NOTNULL(func);
  return func(context,
              flags,
              image_format,
...
cl_command_queue clCreateCommandQueue(cl_context context,
                                      ...
                                      cl_int *errcode_ret) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clCreateCommandQueue;
  MNN_CHECK_NOTNULL(func);
...
cl_int clEnqueueCopyImage(cl_command_queue queue,
                          ...
                          const cl_event *event_wait_list,
                          cl_event *event) {
  auto func = NNM::OpenCLSymbolsOperator::getOpenclSymbolsPtr()->clEnqueueCopyImage;
  MNN_CHECK_NOTNULL(func);
  return func(queue,
              src_image,
              dst_image,
